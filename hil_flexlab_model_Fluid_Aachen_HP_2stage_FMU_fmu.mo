within ;
model hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu
...
public
  parameter String fmi_instanceName="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu"
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu/Resources/Library/FMU/hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU/resources")
...
package fmi_Functions
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_Instantiate_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
    if (!(res->hInst=LoadLibrary(\"hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU.so\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU.so) failed!\");
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2ModelExchange, \"{38f39b90-c524-4e1d-8982-46e1566c19c3}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU", LibraryDirectory="modelica://hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu/Resources/Library/FMU/hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU/binaries",__Dymola_doNotLinkSharedObject=true, __Dymola_CriticalRegion="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
        ...
        input fmiModel fmi;
        external"C"
                   hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiFreeModelInstance2(fmi);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_Free_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    input fmiModel fmi;
    input Real ti;
    external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetTime2(fmi, ti);
    annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetTime_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetTime_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetTime2(void*m, double ti) {
  struct dy_fmi2Extended*a=m;
...
#endif", Library="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU", LibraryDirectory="modelica://hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu/Resources/Library/FMU/hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU/binaries",__Dymola_doNotLinkSharedObject=true, __Dymola_CriticalRegion="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU",__Dymola_IdemPotent=true);
    end fmiSetTime;

    function fmiSetContinuousStates
    input fmiModel fmi;
    input Real x[:];
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetContinuousStates2(
       fmi,
       x,
       size(x, 1));
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetContinuousStates_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetContinuousStates_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetContinuousStates2(void*m, const double*x, size_t nx) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetContinuousStates failed\");
    ...
    input Real preAvailable;
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetContinuousStates2(
        fmi,
        x,
        nx);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetContinuousStates_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetContinuousStates_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetContinuousStates2(void*m, double*x, int nx) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetContinuousStates failed\");
    ...
    output Real crossing;
      external"C" crossing = hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiCompletedIntegratorStep2(fmi);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_CompletedIntegratorStep_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_CompletedIntegratorStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiCompletedIntegratorStep2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status = fmi2Fatal;
  ...
  return a->dyTriggered && a->dyTime>=a->dyLastTime;
    ...
    external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiEnterModelInitialization2(fmi, startTime);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiEnterModelInitialization_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiEnterModelInitialization_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiEnterModelInitialization2(void*m, double startTime) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"Initialize failed\");
    ...
    external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiExitModelInitializationMode2(fmi);
    annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiExitModelInitializationMode_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    external"C" nextMode = hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiUpdateDiscreteStates2(fmi, tNext, stateValuesChanged);
      annotation(Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_UpdateDiscreteStates_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_UpdateDiscreteStates_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
int hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiUpdateDiscreteStates2(void*m, double* tNext, int* stateValuesChanged){
  struct dy_fmi2Extended*a=m;
  fmi2EventInfo ev;
  fmi2Status status=fmi2Fatal;
  ...
  *stateValuesChanged = ev.valuesOfContinuousStatesChanged;
  return ev.newDiscreteStatesNeeded;
    ...
    input Integer nx;
    output Real dx[nx];
    external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetDerivatives2(
    fmi,
      dx,
      nx);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetDerivatives_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetDerivatives_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetDerivatives2(void*m,double*dx,int nx) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetDerivatives failed\");
    ...
    input Integer nz;
    output Real z[nz];
    external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetEventIndicators2(
      fmi,
      z,
      nz);
    annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetEventIndicators_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetEventIndicators_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetEventIndicators2(void*m,double*z,int nz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
;  }
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetEventIndicators failed\");
    ...
    function fmiReset
      ...
      external"C" resetOK = hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiReset2(fmi);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_Reset_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetReal_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetReal_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
#endif", Library="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU", LibraryDirectory="modelica://hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu/Resources/Library/FMU/hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU/binaries",__Dymola_doNotLinkSharedObject=true, __Dymola_CriticalRegion="hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU",__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    end fmiSetReal;
...
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetReal failed\");
    ...
    function fmiGetInteger
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetInteger_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetInteger_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetBoolean_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetBoolean_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetString_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetDirectionalDerivative2_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiCheckIfDiscreteValueSet
      input fmiModel fmi;
      output Real DiscreteInputSet;
      external "C" DiscreteInputSet = hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiCheckIfDiscreteValueSet2(fmi);
      annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiCheckIfDiscreteValueSet_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiCheckIfDiscreteValueSet_C 1
#include \"FMI/fmi2Import.h\"
double hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiCheckIfDiscreteValueSet2(void*m) {
  struct dy_fmi2Extended*a=m;
  if (a) {
  ...
  return 0;
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSaveFMUState2(fmi);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSaveFMUState_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiRestoreFMUState2(fmi);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiRestoreFMUState_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSerializeFMUstate2(fmi);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSerializeFMUstate_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiDeSerializeFMUstate2(fmi);
        annotation (Header="
#ifndef hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiDeSerializeFMUstate_C
#define hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU383990524418982461566193_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
<li>modelName = hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU</li>
<li>generationTool = Dymola Version 2020x (64-bit), 2019-10-10 (requires license to execute)</li>
<li>generationDateAndTime = 2022-03-23T17:35:14Z</li>
</ul>
...
end hil_flexlab_model_Fluid_Aachen_HP_2stage_FMU_fmu;
