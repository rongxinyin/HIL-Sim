...
class Chiller_Heatpump_Model(Driver):
    def __init__(self, config_file="read_data_config.yaml"):
        ...
        self.chiller_config = self.config.get('emulated_chiller_heatpump')
        ...
        self.emulated_chiller_table_name = self.chiller_config.get('db_table_name', 'emulated_chiller_heatpump')
...
if __name__ == "__main__":
    obj = Chiller_Heatpump_Model(config_file='read_data_config.yaml')
    obj.write_to_db()
