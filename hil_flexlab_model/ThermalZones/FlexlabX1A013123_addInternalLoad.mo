...
model FlexlabX1A013123_addInternalLoad "Model of a flexlab x1a"
  ...
  Buildings.Occupants.ThermalZones.Detailed.MixedAir clo(
    redeclare package Medium = Medium,
    hRoo=3.6576,
    AFlo=3.93,
  ...
  Buildings.Occupants.ThermalZones.Detailed.MixedAir ele(
    redeclare package Medium = Medium,
    hRoo=3.6576,
    AFlo=2.39,
    lat=0.66098585832754,
  ...
  Modelica.Blocks.Sources.CombiTimeTable pluSch(
    ...
    annotation (Placement(transformation(extent={{190,428},{210,448}})));
  ...
  Modelica.Blocks.Sources.CombiTimeTable additionalLoad(
    table=[0,0.5; 8,0.5; 8,0; 10,0; 10,-0.5; 12,-0.5; 12,0; 15,0; 15,2; 18,2;
        18,0.5; 24,0.5],
    timeScale=3600,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    "internal heat gain from plug"
    annotation (Placement(transformation(extent={{182,462},{202,482}})));
  Modelica.Blocks.Math.Add add
    annotation (Placement(transformation(extent={{232,430},{252,450}})));
equation
  ...
  connect(add.y, plgGai.u[1]) annotation (Line(points={{253,440},{270,440},{270,
          438},{282,438}}, color={0,0,127}));
  connect(additionalLoad.y[1], add.u1) annotation (Line(points={{203,472},{218,
          472},{218,446},{230,446}}, color={0,0,127}));
  connect(pluSch.y[1], add.u2) annotation (Line(points={{211,438},{222,438},{
          222,434},{230,434}}, color={0,0,127}));
...
end FlexlabX1A013123_addInternalLoad;
