  ...
  model TestCellRotate_3ConBou
    ...
    extends Buildings.ThermalZones.Detailed.MixedAir(AFlo=60.97,
        ...
        datConExt(
           ...
           azi={Buildings.Types.Azimuth.S, Buildings.Types.Azimuth.S, Buildings.Types.Azimuth.E}),
        datConBou(
           layers = {celDiv, parCon,R20Wal},
           A = {3.6576 * 9.144, 3.6576*2.886075-2.39*1.22, 6.645*9.144},
           til = {Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Ceiling},
           azi = {Buildings.Types.Azimuth.W, Buildings.Types.Azimuth.S, Buildings.Types.Azimuth.S},
           stateAtSurface_a = {false, true, true}),
        datConExtWin(
          layers={R16p8Wal},
          A={6.6675*3.6576},
          glaSys={glaSys},
