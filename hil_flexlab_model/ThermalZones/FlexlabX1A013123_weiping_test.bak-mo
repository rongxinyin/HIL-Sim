...
model FlexlabX1A013123_weiping_test "Model of a flexlab x1a"
 ...
 //   "Design mass flow rate perimeter 3";
  ...
  Modelica.Fluid.Vessels.BaseClasses.VesselFluidPorts_b portsSou[2](
    ...
    annotation (Placement(transformation(extent={{-54,-22},{-14,-6}})));
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem(m_flow_nominal=
        m_flow_nominal)
    annotation (Placement(transformation(extent={{12,-8},{32,12}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem1(m_flow_nominal=
        m_flow_nominal)
...
equation
  ...
  connect(opeSouCor.port_a2, cor.ports[4]) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=0.5));
  connect(opeSouCor.port_a1, sou.ports[1]) annotation (Line(
      points={{84,16},{74,16},{74,-20},{134,-20},{134,-37.2},{149,-37.2}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(opeSouCor.port_b2, sou.ports[2]) annotation (Line(
      points={{84,4},{74,4},{74,-20},{134,-20},{134,-35.6},{149,-35.6}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(leaSou.port_b, sou.ports[3]) annotation (Line(points={{-20,420},{-16,420},
          {-16,-34},{149,-34}},     color={0,127,255}));
  ...
  connect(portsSou[2], senTem.port_a) annotation (Line(points={{-24,-14},{-10,-14},
          {-10,2},{12,2}}, color={0,127,255}));
  connect(sou.ports[4], senTem.port_b) annotation (Line(points={{149,-32.4},{100,
          -32.4},{100,-12},{32,-12},{32,2}}, color={0,127,255}));
  connect(portsSou[1], senTem1.port_a) annotation (Line(points={{-44,-14},{-44,-68},
          {-2,-68}}, color={0,127,255}));
  connect(senTem1.port_b, sou.ports[5]) annotation (Line(points={{18,-68},{149,-68},
          {149,-30.8}}, color={0,127,255}));
...
end FlexlabX1A013123_weiping_test;
