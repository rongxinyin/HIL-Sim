...
model Floor_withPlenum "Model of a floor of the building"
  extends hil_flexlab_model.ThermalZones.PartialFloor_withPlenum(
    VRooCor=456.455,
    VRooSou=346.022,
    VRooNor=346.022,
    VRooPle=98.397,
  ...
  Buildings.Occupants.ThermalZones.EnergyPlus_9_6_0.ThermalZone sou(
    redeclare package Medium = Medium,
    nPorts=6,
    zoneName="Perimeter_ZN_1") "South zone"
    annotation (Placement(transformation(extent={{144,-44},{184,-4}})));
  Buildings.Occupants.ThermalZones.EnergyPlus_9_6_0.ThermalZone nor(
    redeclare package Medium = Medium,
    nPorts=6,
    zoneName="Perimeter_ZN_3") "North zone"
    annotation (Placement(transformation(extent={{144,116},{184,156}})));
  Buildings.Occupants.ThermalZones.EnergyPlus_9_6_0.ThermalZone cor(
    redeclare package Medium = Medium,
    nPorts=10,
  ...
  Buildings.Occupants.ThermalZones.EnergyPlus_9_6_0.ThermalZone ple(
    redeclare package Medium = Medium,
    nPorts=5,
    zoneName="Perimeter_ZN_2") "Ceiling Plenum"
    annotation (Placement(transformation(extent={{302,-12},{342,28}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heaPorPle
    "Heat port to air volume corridor" annotation (Placement(transformation(
          extent={{268,-8},{288,12}}), iconTransformation(extent={{258,42},{278,
            62}})));
protected
  inner Buildings.Occupants.ThermalZones.EnergyPlus_9_6_0.Building building(
    idfName=idfName,
    epwName=epwName,
    weaName=weaName,
...
equation
  ...
  connect(sou.ports[1],portsSou[1])
    annotation (Line(points={{160.667,-43.1},{164,-43.1},{164,-54},{86,-54},{86,
          -36},{80,-36}},                                                                    color={0,127,255},smooth=Smooth.None));
  connect(sou.ports[2],portsSou[2])
    annotation (Line(points={{162,-43.1},{164,-43.1},{164,-54},{86,-54},{86,-36},
          {100,-36}},                                                                         color={0,127,255},smooth=Smooth.None));
  connect(nor.ports[1],portsNor[1])
    annotation (Line(points={{160.667,116.9},{164,116.9},{164,106},{88,106},{88,
          124},{80,124}},                                                                    color={0,127,255},smooth=Smooth.None));
  connect(nor.ports[2],portsNor[2])
    annotation (Line(points={{162,116.9},{164,116.9},{164,106},{88,106},{88,124},
          {100,124}},                                                                         color={0,127,255},smooth=Smooth.None));
  connect(cor.ports[1],portsCor[1])
    annotation (Line(points={{160.4,60.9},{164,60.9},{164,26},{90,26},{90,46},{
          80,46}},                                                                       color={0,127,255},smooth=Smooth.None));
  connect(cor.ports[2],portsCor[2])
    annotation (Line(points={{161.2,60.9},{164,60.9},{164,26},{90,26},{90,46},{
          100,46}},                                                                       color={0,127,255},smooth=Smooth.None));
  connect(leaSou.port_b,sou.ports[3])
    annotation (Line(points={{-22,372},{-2,372},{-2,-72},{134,-72},{134,-54},{
          163.333,-54},{163.333,-43.1}},                                                            color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(leaNor.port_b,nor.ports[3])
    annotation (Line(points={{-20,320},{138,320},{138,116.9},{163.333,116.9}},
                                                                          color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeSouCor.port_b1,cor.ports[3])
    annotation (Line(points={{104,16},{164,16},{164,34},{162,34},{162,60.9}},        color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeSouCor.port_a2,cor.ports[4])
    annotation (Line(points={{104,4},{164,4},{164,60.9},{162.8,60.9}},  color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeSouCor.port_a1,sou.ports[4])
    annotation (Line(points={{84,16},{74,16},{74,-20},{134,-20},{134,-54},{162,
          -54},{162,-46},{164,-46},{164,-43.1},{164.667,-43.1}},                                                                   color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeSouCor.port_b2,sou.ports[5])
    annotation (Line(points={{84,4},{74,4},{74,-18},{134,-18},{134,-52},{164,
          -52},{164,-43.1},{166,-43.1}},                                                                     color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeNorCor.port_b1,nor.ports[4])
    annotation (Line(points={{100,90},{108,90},{108,106},{164,106},{164,116.9},
          {164.667,116.9}},                                                                   color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeNorCor.port_a2,nor.ports[5])
    annotation (Line(points={{100,78},{108,78},{108,106},{164,106},{164,116.9},
          {166,116.9}},                                                                       color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeNorCor.port_a1,cor.ports[5])
    annotation (Line(points={{80,90},{76,90},{76,60},{142,60},{142,60.9},{163.6,
          60.9}},                                                                        color={0,127,255},smooth=Smooth.None));
  connect(opeNorCor.port_b2,cor.ports[6])
    annotation (Line(points={{80,78},{76,78},{76,60},{142,60},{142,60.9},{164.4,
          60.9}},                                                                        color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(cor.ports[7], senRelPre.port_a)
    annotation (Line(points={{165.2,60.9},{164,60.9},{164,24},{128,24},{128,250},
  ...
  connect(temAirple.port, ple.heaPorAir) annotation (Line(points={{288,322},{282,
          322},{282,48},{322,48},{322,8}}, color={191,0,0}));
  connect(qGai_flow.y, ple.qGai_flow)
    annotation (Line(points={{-118,-30},{300,-30},{300,18}}, color={0,0,127}));
  connect(heaPorPle, ple.heaPorAir) annotation (Line(points={{278,2},{300,2},{300,
          8},{322,8}}, color={191,0,0}));
  connect(opePleCor.port_a1, cor.ports[8]) annotation (Line(points={{180,46},{
          166,46},{166,60.9}}, color={0,127,255}));
  connect(opePleCor.port_b2, cor.ports[9]) annotation (Line(points={{180,34},{
          174,34},{174,36},{166.8,36},{166.8,60.9}}, color={0,127,255}));
  connect(opePleCor.port_b1, ple.ports[1]) annotation (Line(points={{200,46},{
          236,46},{236,-48},{318.8,-48},{318.8,-11.1}},
                                                    color={0,127,255}));
  connect(opePleCor.port_a2, ple.ports[2]) annotation (Line(points={{200,34},{
          238,34},{238,-46},{320.4,-46},{320.4,-11.1}},
                                                    color={0,127,255}));
  connect(leaPle.port_b, ple.ports[3]) annotation (Line(points={{-22,426},{322,
          426},{322,-11.1}},
                        color={0,127,255}));
  connect(ple.ports[4], portsPle[2]) annotation (Line(points={{323.6,-11.1},{
          323.6,-38},{288,-38},{288,32}},
                                    color={0,127,255}));
  connect(nor.ports[6], portsNor[1]) annotation (Line(points={{167.333,116.9},{
          167.333,116},{80,116},{80,124}},
                                   color={0,127,255}));
  connect(portsCor[1], cor.ports[10]) annotation (Line(points={{80,46},{80,32},
          {167.6,32},{167.6,60.9}},    color={0,127,255}));
  connect(portsSou[1], sou.ports[6]) annotation (Line(points={{80,-36},{80,-64},
          {167.333,-64},{167.333,-43.1}},color={0,127,255}));
  connect(portsPle[1], ple.ports[5]) annotation (Line(points={{268,32},{268,-38},
          {328,-38},{328,-11.1},{325.2,-11.1}},   color={0,127,255}));
  annotation (
    Diagram(
      coordinateSystem(
