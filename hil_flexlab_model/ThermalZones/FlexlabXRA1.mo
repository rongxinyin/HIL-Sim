...
model FlexlabXRA1 "Model of a flexlab xra"
   ...
   Modelica.Blocks.Interfaces.RealOutput TRooAir(each unit="K", each displayUnit=
        "degC") "Room air temperatures" annotation (Placement(transformation(
           extent={{402,184},{422,204}}), iconTransformation(extent={{402,184},{
            422,204}})));
  ...
  XRA1.TestCell testCell(nPorts=5)
   ...
   Modelica.Fluid.Vessels.BaseClasses.VesselFluidPorts_b portsCell[2](redeclare
     ...
     annotation (Placement(transformation(extent={{-20,-8},{20,8}},
        rotation=90,
        origin={-164,94}), iconTransformation(
        extent={{-20,-8},{20,8}},
        rotation=90,
        origin={-164,94})));
  XRA1.Closet closet(nPorts=2)
    annotation (Placement(transformation(extent={{176,362},{216,402}})));
  XRA1.Electrical electrical
...
equation
   ...
   connect(multiplex3_1.y, testCell.qGai_flow) annotation (Line(points={{17,294},
   ...
   connect(temAirCellA.T, TRooAir[1]) annotation (Line(points={{288,180},{350,180},
          {350,194},{412,194}},       color={0,0,127}));
   ...
   connect(weaBus, electrical.weaBus) annotation (Line(
       ...
       horizontalAlignment=TextAlignment.Right));
         ...
         Rectangle(
           extent={{-156,-98},{396,244}},
           lineColor={95,95,95},
           fillColor={95,95,95},
           fillPattern=FillPattern.Solid),
         Rectangle(
           extent={{-142,232},{378,-86}},
         ...
         Rectangle(
           ...
           fillPattern=FillPattern.Sphere),
         Polygon(
           points={{-112,224},{-8,118},{-16,112},{-124,216},{-112,224}},
           smooth=Smooth.None,
           fillColor={95,95,95},
           fillPattern=FillPattern.Solid,
           pattern=LinePattern.None),
         Polygon(
           points={{260,40},{372,-78},{362,-86},{254,32},{260,40}},
           smooth=Smooth.None,
           fillColor={95,95,95},
           fillPattern=FillPattern.Solid,
           pattern=LinePattern.None),
         Polygon(
           points={{256,118},{354,222},{364,216},{264,112},{256,118}},
           smooth=Smooth.None,
           fillColor={95,95,95},
           fillPattern=FillPattern.Solid,
           pattern=LinePattern.None),
         ...
         Rectangle(
           ...
           fillPattern=FillPattern.Solid),
         Polygon(
           points={{-138,-70},{-10,44},{-2,38},{-130,-80},{-138,-70}},
           smooth=Smooth.None,
           fillColor={95,95,95},
           fillPattern=FillPattern.Solid,
           pattern=LinePattern.None),
         Rectangle(
           extent={{332,144},{352,4}},
           lineColor={95,95,95},
           fillColor={255,255,255},
           fillPattern=FillPattern.Solid),
         Rectangle(
           extent={{338,144},{346,4}},
           lineColor={95,95,95},
           fillColor={170,213,255},
           fillPattern=FillPattern.Solid),
         Rectangle(
           extent={{-26,192},{268,200}},
           lineColor={95,95,95},
           fillColor={170,213,255},
           fillPattern=FillPattern.Solid),
         Rectangle(
           extent={{-26,182},{268,202}},
           lineColor={95,95,95},
           fillColor={255,255,255},
           fillPattern=FillPattern.Solid),
         Rectangle(
           extent={{-26,188},{268,196}},
           lineColor={95,95,95},
           fillColor={170,213,255},
           fillPattern=FillPattern.Solid),
         Text(
           extent={{-104,238},{-82,208}},
           lineColor={0,0,255},
           textString="dP")}),
