...
model FlexlabX1A013123_addScaleParameters "Model of a flexlab x1a"

    parameter Real wWinFra = 0.5
    "Uncertainty factor to scale window width in xrb";
    parameter Real tauFra = 2.2
...
end FlexlabX1A013123_addScaleParameters;
