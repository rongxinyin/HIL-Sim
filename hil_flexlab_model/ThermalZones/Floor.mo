...
equation
  ...
  connect(leaPle.port_b,ple.ports[1])
    annotation (Line(points={{-22,360},{246,360},{246,68.9},{318.667,68.9}},
                                                                        color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(leaNor.port_b,nor.ports[1])
    annotation (Line(points={{-20,320},{138,320},{138,116.9},{162.667,116.9}},
                                                                          color={0,127,255},smooth=Smooth.None,thickness=0.5));
  ...
  connect(heatCapacitor2.port, nor.heaPorAir) annotation (Line(points={{208,140},
        ...
        color={191,0,0}));
  connect(ple.ports[2], portsEas[1]) annotation (Line(points={{320,68.9},{318,
          68.9},{318,36},{325,36}}, color={0,127,255}));
  connect(portsEas[2], ple.ports[3]) annotation (Line(points={{335,36},{335,
          68.9},{321.333,68.9}}, color={0,127,255}));
  connect(portsNor[1], nor.ports[2]) annotation (Line(points={{85,124},{92,124},
          {92,96},{164,96},{164,116.9}}, color={0,127,255}));
  connect(portsNor[2], nor.ports[3]) annotation (Line(points={{95,124},{88,124},
          {88,106},{165.333,106},{165.333,116.9}}, color={0,127,255}));
  annotation (
    Diagram(
      coordinateSystem(
