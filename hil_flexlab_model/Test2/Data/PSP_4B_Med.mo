within hil_flexlab_model.Test2.Data;
record PSP_4B_Med "Portable (SW facing) Classroom in Albuquerque, New Mexico"
  extends hil_flexlab_model.Test2.Data.BaseClasses.PSP;
  extends hil_flexlab_model.Test2.Data.BaseClasses.MAPR;
  extends hil_flexlab_model.Test2.Data.BaseClasses.OPCO(TSetSupAirCoo=12.8 +
        273.15, TSetSupAirHea=50 + 273.15);
  extends hil_flexlab_model.Test2.Data.BaseClasses.DELO(
