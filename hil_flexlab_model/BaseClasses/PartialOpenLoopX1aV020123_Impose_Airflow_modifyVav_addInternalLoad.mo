...
partial model
  PartialOpenLoopX1aV020123_Impose_Airflow_modifyVav_addInternalLoad
...
equation
  ...
  connect(cooCoi.port_b2, fanSup.port_a)
    annotation (Line(points={{210,-40},{236,-40}}, color={0,127,255}));
  connect(fanSup.port_b, proSou.port_a)
    annotation (Line(points={{256,-40},{284,-40}}, color={0,127,255}));
  connect(proSou.port_b, TSup.port_a)
    annotation (Line(points={{304,-40},{330,-40}}, color={0,127,255}));
...
end PartialOpenLoopX1aV020123_Impose_Airflow_modifyVav_addInternalLoad;
