...
equation
  ...
  connect(uRetDamPosMax, retDamSwitch.u3) annotation (Line(points={{-300,-140},{
          -172,-140},{-172,-160},{-42,-160}}, color={0,0,127}));
  connect(uRetDamPosMin, retDamSwitch.u1) annotation (Line(points={{-300,-180},{
          -142,-180},{-142,-144},{-42,-144}}, color={0,0,127}));
  connect(uOutDamPosMax, outDamSwitch.u1) annotation (Line(points={{-300,-20},{-120,
          -20},{-120,-42},{60,-42}}, color={0,0,127}));
  connect(uOutDamPosMin, outDamSwitch.u3) annotation (Line(points={{-300,-60},{-120,
          -60},{-120,-58},{60,-58}}, color={0,0,127}));
  connect(not2.y, delOutDamOsc.u)
    annotation (Line(points={{-23,-30},{-12,-30}}, color={255,0,255}));
  connect(delOutDamOsc.y, not3.u)
    annotation (Line(points={{12,-30},{22,-30}}, color={255,0,255}));
  connect(not3.y, outDamSwitch.u2) annotation (Line(points={{45,-30},{52,-30},{52,
          -50},{60,-50}}, color={255,0,255}));
  connect(hysOutTem.y, not4.u)
    annotation (Line(points={{-76,250},{-50,250}}, color={255,0,255}));
  connect(not4.y, truFalHol.u) annotation (Line(points={{-27,250},{-14,250},{-14,
          210},{-2,210}}, color={255,0,255}));
  connect(and1.y, not2.u) annotation (Line(points={{22,110},{-86,110},{-86,-30},
          {-46,-30}}, color={255,0,255}));
  connect(and1.y, delRetDam.u) annotation (Line(points={{22,110},{-86,110},{-86,
          -80},{-42,-80}}, color={255,0,255}));
  connect(and1.y, retDamSwitch.u2) annotation (Line(points={{22,110},{-86,110},{
          -86,-152},{-42,-152}}, color={255,0,255}));
  connect(and1.y, and2.u1) annotation (Line(points={{22,110},{106,110},{106,-70},
...
limit assignments
with delays"),                   Text(
          extent={{116,110},{210,100}},
          lineColor={0,0,0},
          horizontalAlignment=TextAlignment.Left,
          textString="Supply fan status"),
        Text(
          extent={{-40,246},{130,236}},
          lineColor={0,0,0},
          fontSize=6,
          textString="At this point, \"True\" means we want 
the economizer to turn on and vice versa"),
        Text(
          extent={{-242,126},{-42,112}},
          lineColor={0,0,0},
          textString="Only if the supply fan is on, the economizer will turn on",
          fontSize=6)}),
