...
partial model PartialOpenLoopX1aNoLeakage0721
...
public
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow pumSou(
    ...
    dp_nominal=12000) "Pump serving source" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={222,-92})));
  Buildings.Utilities.Math.Max max(nin=3) "Computes lowest room temperature"
    annotation (Placement(transformation(extent={{1194,482},{1214,502}})));
equation
  ...
  connect(max.u, flo.TRooAir) annotation (Line(points={{1192,492},{1110,492},{
          1110,494.94},{1028.86,494.94}}, color={0,0,127}));
...
end PartialOpenLoopX1aNoLeakage0721;
