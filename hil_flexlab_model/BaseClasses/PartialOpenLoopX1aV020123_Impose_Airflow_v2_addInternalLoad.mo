...
partial model PartialOpenLoopX1aV020123_Impose_Airflow_v2_addInternalLoad
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  ThermalZones.FlexlabX1A013123_addInternalLoad
                                flo(
...
public
  ...
  Buildings.Fluid.Sources.PropertySource_T                 temperatureChangeNor(use_T_in=
    ...
    annotation (Placement(transformation(extent={{714,98},{734,118}})));
  Buildings.Fluid.Sources.PropertySource_T                 temperatureChangeCor(use_T_in=
        true, redeclare package Medium = MediumA)
    annotation (Placement(transformation(extent={{848,96},{868,116}})));
  Buildings.Fluid.Sources.PropertySource_T                 temperatureChangeSou(use_T_in=
        true, redeclare package Medium = MediumA)
    annotation (Placement(transformation(extent={{1090,86},{1110,106}})));
equation
  ...
  connect(VSupNor_flow.port_b, flo.portsNor[1]) annotation (Line(points={{706,250},
          {706,481.18},{896.857,481.18}}, color={0,127,255}));
  connect(VSupCor_flow.port_b, flo.portsCor[1]) annotation (Line(points={{834,252},
  ...
  connect(VSupSou_flow.port_b, flo.portsSou[1]) annotation (Line(points={{1080,
          248},{1080,378},{898,378},{898,412.38},{896.857,412.38}},
                                                               color={0,127,255}));
  ...
  connect(splSupCor.port_3, fanSupCor.port_a) annotation (Line(points={{834,-30},
          {834,-23},{846,-23},{846,-16}}, color={0,127,255}));
  connect(fanSupCor.port_b, cor.port_a) annotation (Line(points={{866,-16},{876,
          -16},{876,16},{834,16},{834,24}}, color={0,127,255}));
  connect(splSupCor.port_2, fanSupSou.port_a) annotation (Line(points={{844,-40},
          {904,-40},{904,-44},{962,-44}}, color={0,127,255}));
  connect(fanSupSou.port_b, sou.port_a) annotation (Line(points={{982,-44},{
          1036,-44},{1036,-46},{1080,-46},{1080,16}}, color={0,127,255}));
  connect(splSupNor.port_3, fanSupNor.port_a) annotation (Line(points={{706,-30},
          {712,-30},{712,-16},{718,-16}}, color={0,127,255}));
  connect(fanSupNor.port_b, nor.port_a) annotation (Line(points={{738,-16},{746,
          -16},{746,10},{706,10},{706,20}}, color={0,127,255}));
  connect(nor.port_b, temperatureChangeNor.port_a) annotation (Line(points={{706,60},
          {710,60},{710,108},{714,108}},           color={0,127,255}));
  connect(temperatureChangeNor.port_b, TSupNor.port_a) annotation (Line(points={{734,108},
          {752,108},{752,148},{706,148},{706,166}},              color={0,127,
          255}));
  connect(cor.port_b, temperatureChangeCor.port_a) annotation (Line(points={{834,64},
          {834,106},{848,106}},           color={0,127,255}));
  connect(temperatureChangeCor.port_b, TSupCor.port_a) annotation (Line(points={{868,106},
          {876,106},{876,142},{834,142},{834,168}},              color={0,127,
          255}));
  connect(sou.port_b, temperatureChangeSou.port_a) annotation (Line(points={{1080,56},
          {1086,56},{1086,96},{1090,96}},            color={0,127,255}));
  connect(temperatureChangeSou.port_b, TSupSou.port_a) annotation (Line(points={{1110,96},
          {1118,96},{1118,136},{1080,136},{1080,164}},              color={0,
          127,255}));
  connect(cooCoi.port_b2, fanSup.port_a)
    annotation (Line(points={{210,-40},{248,-40}}, color={0,127,255}));
  connect(fanSup.port_b, proSou.port_a)
    annotation (Line(points={{268,-40},{294,-40}}, color={0,127,255}));
  connect(proSou.port_b, TSup.port_a)
    annotation (Line(points={{314,-40},{330,-40}}, color={0,127,255}));
...
end PartialOpenLoopX1aV020123_Impose_Airflow_v2_addInternalLoad;
