...
model Window_weiping "Model for a window"
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityOutflow JOutUns_a
    "Outgoing radiosity that connects to unshaded part of glass at exterior side"
    annotation (Placement(transformation(extent={{-200,70},{-220,90}})));
  Buildings.HeatTransfer.Interfaces.RadiosityInflow JInUns_a
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityOutflow JOutSha_a if haveShade
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityInflow JInSha_a if haveShade
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityOutflow JOutUns_b
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityInflow JInUns_b
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityOutflow JOutSha_b if haveShade
    "Outgoing radiosity that connects to shaded part of glass at room-side"
    annotation (Placement(transformation(extent={{200,-70},{220,-50}})));
  Buildings.HeatTransfer.Interfaces.RadiosityInflow JInSha_b if haveShade
...
protected
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.ShadingSignal shaSig(final
  ...
  parameter Buildings.HeatTransfer.Data.Solids.Plywood matFra(x=0.03)
  ...
  parameter Buildings.HeatTransfer.Data.Solids.Glass matGla(
