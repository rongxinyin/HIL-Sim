...
model HeatRecoveryIEC
  ...
  Buildings.Fluid.Sensors.RelativeHumidityTwoPort senRelHumExhAir(
    ...
    tau=0) "Relative humidity of exhaust air" annotation (Placement(
        ...
        rotation=0,
        origin={-70,-60})));
  hil_flexlab_model.BaseClasses.IdealValve idealValve(redeclare package Medium =
        Medium2, m_flow_nominal=m2_flow_nominal) annotation (Placement(
        transformation(
        extent={{-10,10},{10,-10}},
        rotation=-90,
        origin={40,26})));
  hil_flexlab_model.BaseClasses.IdealValve idealValve1(redeclare package Medium =
