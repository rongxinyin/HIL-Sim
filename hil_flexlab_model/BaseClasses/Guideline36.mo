...
model Guideline36
  ...
  extends hil_flexlab_model.BaseClasses.PartialHVAC(
    damOut(
      dpDamper_nominal=10,
      dpFixed_nominal=10),
    amb(nPorts=3),
  ...
  Controls.Controller                                                 conAHU(
    ...
    resAmoSupTem=0)
    "AHU controller"
    annotation (Placement(transformation(extent={{340,516},{420,644}})));
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TZonSetHea0[numZon](
      each k(
      unit="K",
      displayUnit="degC") = 293.15) "Heating setpoint for zone air"
    annotation (Placement(transformation(extent={{-318,602},{-298,622}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TZonSetCoo0[numZon](
      each k(
      unit="K",
      displayUnit="degC") = 297.15) "Cooling setpoint for zone air"
    annotation (Placement(transformation(extent={{-308,554},{-288,574}})));
  Modelica.Blocks.Sources.CombiTimeTable TZonSetCoo(
    table=[0,26.6667; 5,26.6667; 5,25.5556; 6,25.5556; 6,25; 7,25; 7,23.3333;
        10,23.3333; 10,22.2222; 14,22.2222; 14,25.5556; 18,25.5556; 18,23.3333;
        22,23.3333; 22,26.6667; 24,26.6667],
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    timeScale=3600) "cooling schedule for demand response"
    annotation (Placement(transformation(extent={{-378,410},{-358,430}})));
  Modelica.Blocks.Sources.CombiTimeTable TZonSetHea(
    ...
    annotation (Placement(transformation(extent={{-374,464},{-354,484}})));
  Modelica.Blocks.Routing.Multiplex3 multiplex3_1
    annotation (Placement(transformation(extent={{-306,496},{-286,516}})));
  ...
  Buildings.Controls.OBC.UnitConversions.From_degC from_degC
    annotation (Placement(transformation(extent={{-350,504},{-330,524}})));
  Buildings.Controls.OBC.UnitConversions.From_degC from_degC1
    annotation (Placement(transformation(extent={{-352,440},{-332,460}})));
equation
  ...
  connect(conAHU.yAveOutAirFraPlu, zonToSys.yAveOutAirFraPlu) annotation (Line(
        points={{424,590.667},{440,590.667},{440,468},{270,468},{270,582},{278,
          582}},
        color={0,0,127}));
  connect(conAHU.VDesUncOutAir_flow, reaRep1.u) annotation (Line(points={{424,
          601.333},{440,601.333},{440,590},{462,590}},
                                              color={0,0,127}));
  connect(reaRep1.y, zonOutAirSet.VUncOut_flow_nominal) annotation (Line(points={{486,590},
          ...
          0,127}));
  connect(conAHU.yReqOutAir, booRep1.u) annotation (Line(points={{424,569.333},
          {444,569.333},{444,560},{462,560}},color={255,0,255}));
  ...
  connect(VOut1.V_flow, conAHU.VOut_flow) annotation (Line(points={{-80,-29},{
          -80,-20},{-60,-20},{-60,546},{138,546},{138,549.778},{336,549.778}},
                                       color={0,0,127}));
  connect(TMix.T, conAHU.TMix) annotation (Line(points={{40,-29},{40,542.667},{
          336,542.667}},
                     color={0,0,127}));
  connect(conAHU.yOutDamPos, damOut.y) annotation (Line(points={{424,526.667},{
          448,526.667},{448,36},{-40,36},{-40,-28}},
                                                 color={0,0,127}));
  connect(conAHU.yRetDamPos, damRet.y) annotation (Line(points={{424,537.333},{
          442,537.333},{442,40},{-20,40},{-20,-10},{-12,-10}},
                                                     color={0,0,127}));
  connect(conAHU.ySupFanSpe, fanSup.y) annotation (Line(points={{424,622.667},{
          432,622.667},{432,-14},{310,-14},{310,-28}},
                                                   color={0,0,127}));
  ...
  connect(conAHU.yCoo, sysHysCoo.u) annotation (Line(points={{424,548},{452,548},
          {452,-262},{0,-262},{0,-240},{18,-240}},           color={0,0,127}));
  connect(conAHU.yHea, sysHysHea.u) annotation (Line(points={{424,558.667},{456,
          558.667},{456,-262},{-56,-262},{-56,-140},{-42,-140}}, color={0,0,127}));
  connect(sysHysHea.sysOn, conAHU.ySupFan) annotation (Line(points={{-42,-134},
          {-62,-134},{-62,-272},{458,-272},{458,633.333},{424,633.333}}, color=
          {255,0,255}));
  ...
  connect(sysHysCoo.sysOn, conAHU.ySupFan) annotation (Line(points={{18,-234},{
          -62,-234},{-62,-272},{458,-272},{458,633.333},{424,633.333}}, color={
          255,0,255}));
  ...
  connect(multiplex3_1.y, optSta.TSetZonHea) annotation (Line(points={{-285,506},
          {-308,506},{-308,418},{-302,418}}, color={0,0,127}));
  connect(multiplex3_2.y, optSta.TSetZonCoo) annotation (Line(points={{-315,418},
          {-308,418},{-308,414},{-302,414}}, color={0,0,127}));
  connect(TZonSetHea.y[1], from_degC.u) annotation (Line(points={{-353,474},{
          -348,474},{-348,514},{-352,514}}, color={0,0,127}));
  connect(from_degC.y, multiplex3_1.u1[1]) annotation (Line(points={{-328,514},
          {-318,514},{-318,513},{-308,513}}, color={0,0,127}));
  connect(from_degC.y, multiplex3_1.u2[1]) annotation (Line(points={{-328,514},
          {-320,514},{-320,506},{-308,506}}, color={0,0,127}));
  connect(from_degC.y, multiplex3_1.u3[1]) annotation (Line(points={{-328,514},
          {-320,514},{-320,499},{-308,499}}, color={0,0,127}));
  connect(TZonSetCoo.y[1], from_degC1.u) annotation (Line(points={{-357,420},{
          -357,434},{-354,434},{-354,450}}, color={0,0,127}));
  connect(from_degC1.y, multiplex3_2.u1[1]) annotation (Line(points={{-330,450},
          {-336,450},{-336,425},{-338,425}}, color={0,0,127}));
  connect(from_degC1.y, multiplex3_2.u2[1]) annotation (Line(points={{-330,450},
          {-334,450},{-334,418},{-338,418}}, color={0,0,127}));
  connect(from_degC1.y, multiplex3_2.u3[1]) annotation (Line(points={{-330,450},
          {-334,450},{-334,411},{-338,411}}, color={0,0,127}));
  annotation (
