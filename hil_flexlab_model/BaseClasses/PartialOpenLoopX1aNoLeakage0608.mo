...
partial model PartialOpenLoopX1aNoLeakage0608
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souCoo(
    ...
    T=279.15,
    use_m_flow_in=false,
    nPorts=1)           "Source for cooling coil" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={230,-168})));
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=
        Modelica.Utilities.Files.loadResource("Resources/weatherdata/US_Berkeley_20210913.mos"))
  ...
  ThermalZones.FlexlabX1A0830 flo(
...
public
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSup1(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={180,-130})));
  Buildings.Fluid.Sensors.VolumeFlowRate VSupNor_flow1(
    redeclare package Medium = MediumW,
    initType=Modelica.Blocks.Types.Init.InitialState,
    m_flow_nominal=m_flow_nominal*1000*40/4200/10,
    allowFlowReversal=allowFlowReversal) "Discharge air flow rate" annotation (
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow pumSou(
    ...
    dp_nominal=12000) "Pump serving source" annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={222,-92})));
equation
  ...
  connect(VSupNor_flow.port_b, flo.portsNor[1]) annotation (Line(points={{708,138},
          {708,481.18},{896.857,481.18}}, color={0,127,255}));
  connect(VSupCor_flow.port_b, flo.portsCor[1]) annotation (Line(points={{880,144},
          {880,248},{800,248},{800,446},{858,446},{858,446.78},{896.857,446.78}},
        color={0,127,255}));
  ...
  connect(splRetCor.port_3, flo.portsCor[2]) annotation (Line(points={{998,10},
          {998,304},{864,304},{864,428},{906,428},{906,446.78},{905.429,446.78}},
        color={0,127,255}));
  connect(splRetNor.port_3, flo.portsNor[2]) annotation (Line(points={{756,10},
          {756,458},{908,458},{908,482},{905.429,482},{905.429,481.18}},color={0,
          127,255}));
  ...
  connect(TSup1.port_a, sinCoo.ports[1]) annotation (Line(points={{180,-140},{180,
          -152},{178,-152}}, color={0,127,255}));
  connect(cooCoi.port_b1, VSupNor_flow1.port_b) annotation (Line(points={{190,-52},
          {180,-52},{180,-86}}, color={0,127,255}));
  connect(VSupNor_flow1.port_a, TSup1.port_b)
    annotation (Line(points={{180,-106},{180,-120}}, color={0,127,255}));
  connect(pumSou.port_b, cooCoi.port_a1) annotation (Line(points={{222,-82},{222,
          -67},{210,-67},{210,-52}}, color={0,127,255}));
  connect(souCoo.ports[1], pumSou.port_a) annotation (Line(points={{230,-158},{226,
          -158},{226,-102},{222,-102}}, color={0,127,255}));
...
end PartialOpenLoopX1aNoLeakage0608;
