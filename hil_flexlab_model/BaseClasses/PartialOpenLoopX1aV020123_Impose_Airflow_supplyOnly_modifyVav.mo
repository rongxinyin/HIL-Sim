...
partial model PartialOpenLoopX1aV020123_Impose_Airflow_supplyOnly_modifyVav
...
equation
  ...
  connect(nor.port_a, splSupNor.port_3)
    annotation (Line(points={{706,20},{706,-30}}, color={0,127,255}));
  connect(cor.port_a, splSupCor.port_3)
    annotation (Line(points={{834,24},{834,-30}}, color={0,127,255}));
  connect(splSupCor.port_2, sou.port_a) annotation (Line(points={{844,-40},{1080,
          -40},{1080,16}}, color={0,127,255}));
...
end PartialOpenLoopX1aV020123_Impose_Airflow_supplyOnly_modifyVav;
