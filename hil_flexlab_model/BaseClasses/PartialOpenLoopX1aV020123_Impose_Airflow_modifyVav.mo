...
partial model PartialOpenLoopX1aV020123_Impose_Airflow_modifyVav
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  ThermalZones.FlexlabX1A013123 flo(
...
end PartialOpenLoopX1aV020123_Impose_Airflow_modifyVav;
