...
First implementation.
  ...
  model RTU_control_FMU_Delay_Cool "Implements common control for RTU system"
    ...
    hil_flexlab_model.Test2.HeatStage heatStage1(
      kSta1=kSta1,
      kSta2=kSta2,
      banSta1=banSta1,
      banSta2=banSta2) annotation (Placement(transformation(
  ...
  block Controller_G36
    ...
    Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u_UnOcc
    ...
    Buildings.Controls.OBC.CDL.Logical.Switch swiFreSta "Switch for SAT setpoint"
  ...
  equation
    ...
    connect(u_UnOcc, swiFreSta.u2) annotation (Line(points={{-220,-334},{-76,-334},
            {-76,-328},{-60,-328}}, color={255,0,255}));
    connect(supTemSetPoi.TSupSet, swiFreSta.u3) annotation (Line(points={{22,180},
            {-20,180},{-20,-336},{-60,-336}}, color={0,0,127}));
    connect(ySupSetUnocc.y, swiFreSta.u1) annotation (Line(points={{-110,-318},
            {-84,-318},{-84,-320},{-60,-320}},
                                          color={0,0,127}));
    connect(swiFreSta.y, val.TSupSet) annotation (Line(points={{-36,-328},{24,-328},
            {24,-60},{78,-60}}, color={0,0,127}));
