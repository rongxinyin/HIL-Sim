...
model ChillerModel_Exchange
 ...
 hil_flexlab_model.AC_Chiller_PrimaryLoop cpl    annotation (Placement(transformation(extent={{6,-28},
  ...
  Modelica.Blocks.Sources.Constant m_in(k=0.32)
  ...
  Modelica.Blocks.Sources.Sine OAT(
    amplitude=15,
    freqHz=0.0000115,
    offset=285) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={22,-54})));
...
equation
  ...
  connect(m_in.y, cpl.mdot_chw_in) annotation (Line(points={{-37,36},{-26,36},{-26,
          -3.3},{12.5875,-3.3}}, color={0,0,127}));
  ...
  connect(OAT.y, cpl.T_air_in) annotation (Line(points={{33,-54},{54,-54},{54,
          -25.7714},{38.9375,-25.7714}},
                               color={0,0,127}));
  connect(On_signal.y, greaterThreshold.u) annotation (Line(points={{-71,78},{-62,
          78},{-62,82},{-50,82}}, color={0,0,127}));
