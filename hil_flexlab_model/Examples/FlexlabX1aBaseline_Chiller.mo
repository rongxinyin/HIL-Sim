...
model FlexlabX1aBaseline_Chiller
  "Variable air volume flow system with terminal reheat - flexlab baseline"
  extends Modelica.Icons.Example;
  extends BaseClasses.PartialOpenLoopX1aV1_Chiller(
    heaCoi(show_T=true),
    cooCoi(show_T=true));
  ...
  Modelica.Blocks.Math.Feedback feedback
    annotation (Placement(transformation(extent={{462,-322},{482,-302}})));
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis         hysChiPla(uLow=-1,
      uHigh=0)
    "Hysteresis with delay to switch on cooling"
    annotation (Placement(transformation(extent={{506,-306},{526,-286}})));
  Buildings.Utilities.Math.Max max(nin=3)
    annotation (Placement(transformation(extent={{1202,384},{1222,404}})));
equation
  ...
  connect(occSch.tNexOcc, controlBus.dTNexOcc) annotation (Line(
      points={{-253,-204},{-240,-204},{-240,-342}},
      color={0,0,127},
      smooth=Smooth.None), Text(
      textString="%second",
      index=1,
  ...
  connect(occSch.occupied, controlBus.occupied) annotation (Line(
      points={{-253,-216},{-240,-216},{-240,-342}},
      color={255,0,255},
      smooth=Smooth.None), Text(
      textString="%second",
      index=1,
  ...
  connect(coiOff.y, swiHeaCoi.u3) annotation (Line(points={{-38,-162},{-28,-162},
          {-28,-218},{58,-218}},
                              color={0,0,127}));
  connect(TSup.T, cooCoiCon.u_m) annotation (Line(points={{366,-45},{366,-12},{372,
          -12},{372,-268},{-70,-268},{-70,-252}},     color={0,0,127}));
  connect(TSup.T, heaCoiCon.u_m) annotation (Line(points={{366,-45},{366,-22},{
          454,-22},{454,-278},{-6,-278},{-6,-232},{-70,-232},{-70,-214}},
        color={0,0,127}));
  connect(gaiHeaCoi.u, swiHeaCoi.y)
    annotation (Line(points={{98,-210},{82,-210},{82,-210}}, color={0,0,127}));
  connect(gaiCooCoi.u, swiCooCoi.y) annotation (Line(points={{162,-232},{88,-232},
  ...
  connect(gaiCooCoi.y, ideVal.y) annotation (Line(points={{186,-232},{194,-232},
          {194,-100},{183,-100}}, color={0,0,127}));
  connect(feedback.u2, controlBus.TRooSetCoo) annotation (Line(points={{472,
          -320},{472,-342},{-240,-342}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(feedback.y, hysChiPla.u) annotation (Line(points={{481,-312},{498,
          -312},{498,-296},{504,-296}}, color={0,0,127}));
  connect(hysChiPla.y, chi.on) annotation (Line(points={{528,-296},{554,-296},{
          554,-332},{414,-332},{414,-323},{274,-323}}, color={255,0,255}));
  connect(max.y, feedback.u1) annotation (Line(points={{1223,394},{1246,394},{
          1246,-312},{464,-312}}, color={0,0,127}));
  connect(max.u, flo.TRooAir) annotation (Line(points={{1200,394},{1028.86,394},
          {1028.86,494.94}}, color={0,0,127}));
  annotation (
