...
model FlexlabX1aNoLeakBaseline1026_SA_G36mod
  "Calbirated model: Modifed G36 seq to match FL implementation"
...
//      ave(nin=3));
  ...
  parameter Modelica.SIunits.Time samplePeriod=900
    "Sample period of component, set to the same value as the trim and respond that process yPreSetReq";
  parameter Modelica.SIunits.PressureDifference dpDisRetMax=40
    "Maximum return fan discharge static pressure setpoint";

  hil_flexlab_model.Controls_HIL.OBC.ASHRAE.G36_PR1.TerminalUnits.Controller conVAVNor(
    ...
    TDisMin=285.95,
    errTZonCoo_1=1.5,
    errTZonCoo_2=0.5)                "Controller for terminal unit north zone"
    annotation (Placement(transformation(extent={{654,2},{674,22}})));
  hil_flexlab_model.Controls_HIL.OBC.ASHRAE.G36_PR1.TerminalUnits.Controller conVAVCor(
    ...
    TDisMin=285.95,
    errTZonCoo_1=1.5,
    errTZonCoo_2=0.5)                "Controller for terminal unit mid zone"
    annotation (Placement(transformation(extent={{778,104},{798,124}})));
  hil_flexlab_model.Controls_HIL.OBC.ASHRAE.G36_PR1.TerminalUnits.Controller conVAVSou(
    ...
    TDisMin=285.95,
    errTZonCoo_1=1.5,
    errTZonCoo_2=0.5) "Controller for terminal unit south zone"
  ...
  Buildings.Controls.OBC.CDL.Integers.MultiSum TZonResReq(nin=1)
    "Number of zone temperature requests"
    annotation (Placement(transformation(extent={{298,288},{318,308}})));
  Buildings.Controls.OBC.CDL.Integers.MultiSum PZonResReq(nin=1, k={1})
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Controller conAHU(
    ...
    triAmoSupTem=0.15,
    resAmoSupTem=-0.3,
    maxResSupTem=-1.2)                                         "AHU controller"
...
equation
  ...
  connect(conVAVNor.yDam,nor.yVAV)  annotation (Line(points={{676,18},{688,18},
          {688,46},{694,46}},color={0,0,127}));
  connect(conVAVNor.yVal,nor.yVal)  annotation (Line(points={{676,13},{684,13},
  ...
  connect(conVAVSou.yZonTemResReq, TZonResReq.u[1]) annotation (Line(points={{1042,38},
          {1054,38},{1054,216},{278,216},{278,298},{296,298}},
        color={255,127,0}));
  connect(conVAVSou.yZonPreResReq, PZonResReq.u[1]) annotation (Line(points={{1042,34},
          {1060,34},{1060,224},{292,224},{292,264},{298,264}},
        color={255,127,0}));
  connect(VSupNor_flow.V_flow,conVAVNor. VDis_flow) annotation (Line(points={{697,128},
          {632,128},{632,10},{652,10}},      color={0,0,127}));
  connect(VSupCor_flow.V_flow, conVAVCor.VDis_flow) annotation (Line(points={{869,134},
          {764,134},{764,112},{776,112}},        color={0,0,127}));
  ...
  connect(conVAVNor.uOpeMod, TZonSet[1].yOpeMod) annotation (Line(points={{652,2},
          {54,2},{54,325},{-10,325}},  color={255,127,0}));
  ...
  connect(conVAVNor.yDam_actual, nor.y_actual) annotation (Line(points={{652,8},
          {642,8},{642,72},{746,72},{746,54},{740,54}},  color={0,0,127}));
  ...
  connect(add.y, conVAVNor.TZonCooSet) annotation (Line(points={{-145,456},{
          -162,456},{-162,20},{652,20}}, color={0,0,127}));
  ...
  connect(conVAVNor.TZon, TRooAir.y3[1]) annotation (Line(points={{652,12},{646,
          12},{646,163},{511,163}}, color={0,0,127}));
  ...
  connect(add1.y, conVAVNor.TZonHeaSet) annotation (Line(points={{-143,280},{
          -182,280},{-182,22},{652,22}}, color={0,0,127}));
...
end FlexlabX1aNoLeakBaseline1026_SA_G36mod;
