...
equation
  ...
  connect(pulse.y, cpl.m_flow_sec) annotation (Line(points={{-69,-16},{-30,-16},
          {-30,-3.3},{12.5875,-3.3}}, color={0,0,127}));
  connect(T_in.y, cpl.T_chw_in) annotation (Line(points={{15,38},{26,38},{26,
