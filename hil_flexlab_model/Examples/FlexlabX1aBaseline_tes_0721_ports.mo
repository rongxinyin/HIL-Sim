...
model FlexlabX1aBaseline_tes_0721_ports
  "Variable air volume flow system with terminal reheat - flexlab baseline"
  extends Modelica.Icons.Example;
  extends hil_flexlab_model.BaseClasses.PartialOpenLoopX1aNoLeakage0721(
    heaCoi(show_T=true),
    cooCoi(show_T=true));
  ...
  hil_flexlab_model.Plants.Baseclasses_WH.AC_AWHP_wTES_debug_ports
...
equation
  ...
  connect(conVAVNor.TRooCooSet, controlBus.TRooSetCoo) annotation (Line(points={{638,40},
          {626,40},{626,-342},{-240,-342}},             color={0,0,127}));
  ...
  connect(gaiCooCoi.y, pumSou.m_flow_in) annotation (Line(points={{122,-248},{
          250,-248},{250,-92},{234,-92}},
                                      color={0,0,127}));
  connect(aC_AWHP_PrimaryLoop_addpts_wTES_weiping062822_1.port_b, pumSou.port_a)
    annotation (Line(points={{178.448,-197.667},{178.448,-149.834},{222,
          -149.834},{222,-102}}, color={0,127,255}));
...
end FlexlabX1aBaseline_tes_0721_ports;
