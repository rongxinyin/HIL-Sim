...
//      ave(nin=3));
  ...
  Modelica.Blocks.Logical.Greater greater_unocc
    annotation (Placement(transformation(extent={{-260,450},{-280,470}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant ecoHigCut1(k=11)
    "economizer high cut off temp"
    annotation (Placement(transformation(extent={{-212,398},{-236,422}})));
  Modelica.Blocks.Math.Add add2(k1=-1, k2=+1)
    annotation (Placement(transformation(extent={{-186,446},{-206,466}})));
equation
  ...
  connect(ecoHigCut.y, conAHU.TOutCut) annotation (Line(points={{88,482},{224,
          482},{224,470.706},{356,470.706}},
                                        color={0,0,127}));
  connect(add.y, add2.u2) annotation (Line(points={{-145,456},{-166,456},{-166,
          450},{-184,450}}, color={0,0,127}));
  connect(add1.y, add2.u1) annotation (Line(points={{-143,280},{-164,280},{-164,
          462},{-184,462}}, color={0,0,127}));
  connect(add2.y, greater_unocc.u1) annotation (Line(points={{-207,456},{-234.5,
          456},{-234.5,460},{-258,460}}, color={0,0,127}));
  connect(ecoHigCut1.y, greater_unocc.u2) annotation (Line(points={{-238.4,410},
          {-248,410},{-248,452},{-258,452}}, color={0,0,127}));
  connect(greater_unocc.y, conAHU.u_UnOcc) annotation (Line(points={{-281,460},
          {38,460},{38,415.741},{355.6,415.741}}, color={255,0,255}));
  annotation (
