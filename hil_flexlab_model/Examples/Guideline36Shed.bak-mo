...
model Guideline36Shed
  ...
  Modelica.Blocks.Sources.CombiTimeTable cooSetDR(
    table=[0,0; 6,0; 6,0; 14,0; 14,2.2; 18,2.2; 18,0; 20,0; 20,0; 24,0],
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    timeScale=3600) "cooling schedule for demand response"
    annotation (Placement(transformation(extent={{494,156},{514,176}})));
  Modelica.Blocks.Math.Add add
    annotation (Placement(transformation(extent={{514,122},{494,142}})));
  Modelica.Blocks.Math.Add add1
    annotation (Placement(transformation(extent={{630,134},{610,154}})));
  Modelica.Blocks.Math.Add add2
    annotation (Placement(transformation(extent={{828,156},{808,176}})));
  Modelica.Blocks.Math.Add add3
    annotation (Placement(transformation(extent={{986,156},{966,176}})));
  Modelica.Blocks.Math.Add add4
    annotation (Placement(transformation(extent={{1142,152},{1122,172}})));
equation
  ...
  connect(cooSetDR.y[1], add.u1) annotation (Line(points={{515,166},{532,166},{
          532,138},{516,138}}, color={0,0,127}));
  connect(TZonSet[1].TZonCooSet, add.u2) annotation (Line(points={{-78,202},{
          580,202},{580,126},{516,126}}, color={0,0,127}));
  connect(add.y, conVAVCor.TZonCooSet) annotation (Line(points={{493,132},{488,
          132},{488,102},{528,102}}, color={0,0,127}));
  connect(cooSetDR.y[1], add1.u1) annotation (Line(points={{515,166},{654,166},
          {654,150},{632,150}}, color={0,0,127}));
  connect(TZonSet[2].TZonCooSet, add1.u2) annotation (Line(points={{-78,202},{
          658,202},{658,138},{632,138}}, color={0,0,127}));
  connect(add1.y, conVAVSou.TZonCooSet) annotation (Line(points={{609,144},{600,
          144},{600,120},{700,120},{700,102}}, color={0,0,127}));
  connect(cooSetDR.y[1], add2.u1) annotation (Line(points={{515,166},{792,166},
          {792,184},{840,184},{840,172},{830,172}}, color={0,0,127}));
  connect(TZonSet[3].TZonCooSet, add2.u2) annotation (Line(points={{-78,202},{
          846,202},{846,160},{830,160}}, color={0,0,127}));
  connect(add2.y, conVAVEas.TZonCooSet) annotation (Line(points={{807,166},{798,
          166},{798,102},{878,102}}, color={0,0,127}));
  connect(cooSetDR.y[1], add3.u1) annotation (Line(points={{515,166},{792,166},
          {792,184},{1000,184},{1000,172},{988,172}}, color={0,0,127}));
  connect(TZonSet[4].TZonCooSet, add3.u2) annotation (Line(points={{-78,202},{
          1010,202},{1010,160},{988,160}}, color={0,0,127}));
  connect(add3.y, conVAVNor.TZonCooSet) annotation (Line(points={{965,166},{958,
          166},{958,102},{1036,102}}, color={0,0,127}));
  connect(cooSetDR.y[1], add4.u1) annotation (Line(points={{515,166},{792,166},
          {792,184},{1168,184},{1168,168},{1144,168}}, color={0,0,127}));
  connect(TZonSet[5].TZonCooSet, add4.u2) annotation (Line(points={{-78,202},{
          1192,202},{1192,156},{1144,156}}, color={0,0,127}));
  connect(add4.y, conVAVWes.TZonCooSet) annotation (Line(points={{1121,162},{
          1116,162},{1116,102},{1238,102}}, color={0,0,127}));
  annotation (
