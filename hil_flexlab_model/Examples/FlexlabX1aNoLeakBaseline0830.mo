...
model FlexlabX1aNoLeakBaseline0830
  ...
  extends BaseClasses.PartialOpenLoopX1aNoLeakage0830(occSch(
      ...
      period=86400), fanSup(per(use_powerCharacteristic=true, power(V_flow={0.05,
              0.1,0.15,0.2,0.25,0.3,0.35,0.4}, P={167,196,225,254,283,312,341,370}))));
...
end FlexlabX1aNoLeakBaseline0830;
