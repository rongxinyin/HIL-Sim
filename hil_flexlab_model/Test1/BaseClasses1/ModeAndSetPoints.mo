...
equation
  connect(TZonSet.uCooDemLimLev,cooDemLimLev. y)
    annotation (Line(points={{76,-88.5714},{36,-88.5714},{36,-140},{22,-140}},
      color={255,127,0}));
  connect(heaDemLimLev.y,TZonSet. uHeaDemLimLev)
    annotation (Line(points={{22,-200},{40,-200},{40,-91.4286},{76,-91.4286}},
      color={255,127,0}));
  connect(TZonSet.TZonCooSet, TZonCooSet)
    annotation (Line(points={{124,-68.5714},{132,-68.5714},{132,110},{180,110}},
      color={0,0,127}));
  connect(TZonSet.TZonHeaSet, TZonHeaSet)
    annotation (Line(points={{124,-80},{140,-80},{140,60},{180,60}},
      color={0,0,127}));
  connect(setAdj, TZonSet.setAdj)
    annotation (Line(points={{-180,-80},{-100,-80},{-100,-81.4286},{76,-81.4286}},
      color={0,0,127}));
  connect(heaSetAdj, TZonSet.heaSetAdj)
    annotation (Line(points={{-180,-120},{-100,-120},{-100,-84.2857},{76,
          -84.2857}},
      color={0,0,127}));
  connect(TZonSet.uOccSen, uOccSen)
    annotation (Line(points={{76,-95.7143},{76,-160},{-180,-160}},
      color={255,0,255}));
  connect(TZonSet.uWinSta, uWinSta)
    annotation (Line(points={{76,-98.5714},{76,-170},{-72,-170},{-72,-200},{
          -180,-200}},
      color={255,0,255}));
  connect(tCooDowHeaUp.y, zonSta.cooDowTim) annotation (Line(points={{-98,190},
          {-74,190},{-74,59},{-62,59}},color={0,0,127}));
  connect(tCooDowHeaUp.y, zonSta.warUpTim) annotation (Line(points={{-98,190},{
          -74,190},{-74,57},{-62,57}},
                                   color={0,0,127}));
