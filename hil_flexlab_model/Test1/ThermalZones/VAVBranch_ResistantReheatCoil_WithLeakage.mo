...
model VAVBranch_ResistantReheatCoil_WithLeakage "Supply branch of a VAV system"
  ...
  Buildings.Fluid.HeatExchangers.HeaterCooler_u leaHea(
    redeclare package Medium = MediumA,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=0,
    Q_flow_nominal=1500) "heat leakage from the reheat coil" annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-48,-64})));
  Modelica.Blocks.Interfaces.RealInput yLea
    "Actuator position for reheat valve (0: closed, 1: open)" annotation (
...
equation
  ...
  connect(port_a, leaHea.port_a) annotation (Line(points={{-50,-100},{-48,-100},
          {-48,-74}}, color={0,127,255}));
  connect(leaHea.port_b, terHea.port_a) annotation (Line(points={{-48,-54},{-48,
          -28},{-46,-28}}, color={0,127,255}));
  connect(leaHea.u, yLea) annotation (Line(points={{-54,-76},{-56,-76},{-56,-80},
...
end VAVBranch_ResistantReheatCoil_WithLeakage;
