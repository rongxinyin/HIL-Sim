...
equation
  ...
  connect(conVAVCor.TZonHeaSet, TZonSet.TZonHeaSet[1]) annotation (Line(points={{529,47},
          {480,47},{480,312.2},{81,312.2}},       color={0,0,127}));
  connect(conVAVCor.TZonCooSet, TZonSet.TZonCooSet[1]) annotation (Line(points={{529,45},
          {480,45},{480,316.2},{81,316.2}},       color={0,0,127}));
  connect(conVAVSou.TZonHeaSet, TZonSet.TZonHeaSet[2]) annotation (Line(points={{699,45},
          {660,45},{660,312.6},{81,312.6}},       color={0,0,127}));
  connect(conVAVSou.TZonCooSet, TZonSet.TZonCooSet[2]) annotation (Line(points={{699,43},
          {660,43},{660,316.6},{81,316.6}},       color={0,0,127}));
  ...
  connect(conVAVNor.TZonHeaSet, TZonSet.TZonHeaSet[4]) annotation (Line(points={{1039,45},
          {1020,45},{1020,313.4},{81,313.4}},        color={0,0,127}));
  connect(conVAVNor.TZonCooSet, TZonSet.TZonCooSet[4]) annotation (Line(points={{1039,43},
          {1020,43},{1020,317.4},{81,317.4}},        color={0,0,127}));
  connect(conVAVWes.TZonHeaSet, TZonSet.TZonHeaSet[5]) annotation (Line(points={{1239,43},
          {1202,43},{1202,313.8},{81,313.8}},        color={0,0,127}));
  connect(conVAVWes.TZonCooSet, TZonSet.TZonCooSet[5]) annotation (Line(points={{1239,41},
          {1202,41},{1202,317.8},{81,317.8}},        color={0,0,127}));
  ...
  connect(conAHU.TZonHeaSet, TZonSet.TZonHeaSet[1]) annotation (Line(points={{383,468},
          {110,468},{110,312.2},{81,312.2}},      color={0,0,127}));
  connect(conAHU.TZonCooSet, TZonSet.TZonCooSet[1]) annotation (Line(points={{383,464},
          {120,464},{120,316.2},{81,316.2}},      color={0,0,127}));
