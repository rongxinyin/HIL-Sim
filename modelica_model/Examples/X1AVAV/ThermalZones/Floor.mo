...
model Floor "Model of a floor of the building"
  ...
  Buildings.ThermalZones.Detailed.MixedAir wes(
    ...
    annotation (Placement(transformation(extent={{16,46},{56,86}})));
...
equation
  connect(sou.surf_conBou[1], wes.surf_surBou[2]) annotation (Line(
      points={{170,-40.6667},{170,-54},{62,-54},{62,20},{32.2,20},{32.2,52.5}},
      color={191,0,0},
      smooth=Smooth.None));
  ...
  connect(nor.surf_conBou[3], wes.surf_surBou[1]) annotation (Line(
      points={{170,120.667},{170,100},{60,100},{60,20},{32.2,20},{32.2,51.5}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(wes.surf_conBou[1], cor.surf_surBou[4]) annotation (Line(
      points={{42,50},{42,30},{160.2,30},{160.2,42.75}},
      color={191,0,0},
      smooth=Smooth.None));
  ...
  connect(replicator.y, wes.uSha) annotation (Line(
      points={{-19,180},{-6,180},{-6,84},{14.4,84}},
      color={0,0,127},
      pattern=LinePattern.Dash,
      smooth=Smooth.None));
  ...
  connect(gai.y, wes.qGai_flow)          annotation (Line(
      points={{-79,110},{-14,110},{-14,74},{14.4,74}},
      color={0,0,127},
      pattern=LinePattern.Dash,
      smooth=Smooth.None));
  ...
  connect(wes.weaBus, weaBus) annotation (Line(
      points={{53.9,83.9},{53.9,168},{210,168},{210,200}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(wes.heaPorAir, temAirWes.port) annotation (Line(
      points={{35,66},{70,66},{70,114},{186,114},{186,258},{292,258}},
      color={191,0,0},
      smooth=Smooth.None));
  ...
  connect(wes.ports[1], portsWes[1]) annotation (Line(
      points={{21,52.8},{-12,52.8},{-12,46},{-40,46}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(wes.ports[2], portsWes[2]) annotation (Line(
      points={{21,54.4},{-2,54.4},{-2,46},{-20,46}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(leaWes.port_b, wes.ports[3]) annotation (Line(
      points={{-20,280},{2,280},{2,56},{21,56}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(opeWesCor.port_a1, wes.ports[4]) annotation (Line(
      points={{20,-4},{2,-4},{2,57.6},{21,57.6}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(opeWesCor.port_b2, wes.ports[5]) annotation (Line(
      points={{20,-16},{2,-16},{2,59.2},{21,59.2}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
