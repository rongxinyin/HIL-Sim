...
model FlexlabX1A "Model of a flexlab x1a"
  ...
  RoomLeakage leaPle(redeclare package Medium = Medium, VRoo=360.0785,
    s=33.27/49.91,
    azi=Buildings.Types.Azimuth.E,
    final use_windPressure=use_windPressure)
    "Model for air infiltration through the envelope"
...
equation
  ...
  connect(weaBus, leaNor.weaBus) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  connect(multiplex4.y, TRooAir) annotation (Line(
      points={{361,290},{372,290},{372,158},{388,158}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(temAirSou.T, multiplex4.u1[1]) annotation (Line(
      points={{310,350},{328,350},{328,299},{338,299}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(temAirPle.T, multiplex4.u2[1]) annotation (Line(
      points={{312,320},{324,320},{324,293},{338,293}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(temAirNor.T, multiplex4.u3[1]) annotation (Line(
      points={{312,290},{326,290},{326,287},{338,287}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(temAirCor.T, multiplex4.u4[1]) annotation (Line(
      points={{312,254},{332,254},{332,281},{338,281}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
