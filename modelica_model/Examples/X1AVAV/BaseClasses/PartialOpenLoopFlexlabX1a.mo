...
partial model PartialOpenLoopFlexlabX1a
  "Partial model of variable air volume flow system with terminal reheat and five thermal zones at flexlab x1a"
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  Buildings.Examples.VAVReheat.ThermalZones.VAVBranch ple(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
    m_flow_nominal=mPle_flow_nominal,
    VRoo=VRooPle,
    allowFlowReversal=allowFlowReversal) "Plenum thermal zone"
  ...
  Buildings.Fluid.FixedResistances.Junction splRetSou(
    redeclare package Medium = MediumA,
    m_flow_nominal={mSou_flow_nominal + mPle_flow_nominal + mNor_flow_nominal,
        mPle_flow_nominal + mNor_flow_nominal,mSou_flow_nominal},
    from_dp=false,
    linearized=true,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    dp_nominal(each displayUnit="Pa") = {0,0,0},
  ...
  Buildings.Fluid.FixedResistances.Junction splRetPle(
    redeclare package Medium = MediumA,
    m_flow_nominal={mPle_flow_nominal + mNor_flow_nominal,mNor_flow_nominal,
        mPle_flow_nominal},
    from_dp=false,
    linearized=true,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
  ...
  Buildings.Fluid.FixedResistances.Junction splSupPle(
    redeclare package Medium = MediumA,
    m_flow_nominal={mPle_flow_nominal + mNor_flow_nominal,mNor_flow_nominal,
        mPle_flow_nominal},
    from_dp=true,
  ...
  Results res(
    final A=ATot,
    PFan=fanSup.P + 0,
    PHea=heaCoi.Q2_flow + cor.terHea.Q1_flow + nor.terHea.Q1_flow + ple.terHea.Q1_flow + sou.terHea.Q1_flow,
...
equation
  ...
  connect(splRetRoo1.port_1, dpRetDuc.port_a) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=0.5));
  connect(splRetPle.port_1, splRetSou.port_2) annotation (Line(
  ...
  connect(splSupSou.port_3, sou.port_a) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=0.5));
  connect(splSupSou.port_2, splSupPle.port_1) annotation (Line(
      points={{770,-40},{930,-40}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(splSupPle.port_3, ple.port_a) annotation (Line(
  ...
  connect(splRetRoo1.port_3, flo.portsCor[2]) annotation (Line(
      points={{640,10},{640,364},{874,364},{874,434},{924,434},{924,450},{
          924.286,450},{924.286,449.533}},
      color={0,127,255},
      thickness=0.5));
  connect(splRetSou.port_3, flo.portsSou[2]) annotation (Line(
      points={{822,10},{822,350},{900,350},{900,428},{924,428},{924,420.2},{
          924.286,420.2}},
      color={0,127,255},
      thickness=0.5));
  connect(splRetPle.port_3, flo.portsPle[2]) annotation (Line(
  ...
  connect(flo.TRooAir, min.u) annotation (Line(
      points={{1092.97,490.6},{1164.7,490.6},{1164.7,450},{1198,450}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(flo.TRooAir, ave.u) annotation (Line(
      points={{1092.97,490.6},{1166,490.6},{1166,420},{1198,420}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(TRooAir.u, flo.TRooAir) annotation (Line(
      points={{488,170},{480,170},{480,538},{1164,538},{1164,490.6},{1092.97,
          490.6}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  ...
  connect(sou.port_b, TSupSou.port_a) annotation (Line(
      ...
      color={0,127,255},
      thickness=0.5));
  connect(ple.port_b, TSupPle.port_a) annotation (Line(
  ...
  connect(TSupSou.port_b, VSupSou_flow.port_a) annotation (Line(
      ...
      color={0,127,255},
      thickness=0.5));
  connect(TSupPle.port_b, VSupPle_flow.port_a) annotation (Line(
  ...
  connect(VSupCor_flow.port_b, flo.portsCor[1]) annotation (Line(
      points={{580,140},{580,372},{848,372},{848,472},{912.571,472},{912.571,
          449.533}},
      color={0,127,255},
      thickness=0.5));

  connect(VSupSou_flow.port_b, flo.portsSou[1]) annotation (Line(
      points={{760,140},{760,358},{926,358},{926,378},{912.571,378},{912.571,
          420.2}},
      color={0,127,255},
      thickness=0.5));
  connect(VSupPle_flow.port_b, flo.portsPle[1]) annotation (Line(
  ...
  connect(heaCoi.port_b1, sinHea.ports[1]) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(nor.port_a, splSupPle.port_2) annotation (Line(points={{1100,20},{
          1100,-40},{950,-40}}, color={0,127,255}));
  connect(flo.portsNor[2], splRetPle.port_2) annotation (Line(points={{924.286,
          478.867},{924.286,480},{1238,480},{1238,0},{1012,0}}, color={0,127,
          255}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-380,
            -400},{1420,600}}), graphics={Line(points={{310,404}}, color={28,
              108,200})}),       Documentation(info="<html>
<p>
