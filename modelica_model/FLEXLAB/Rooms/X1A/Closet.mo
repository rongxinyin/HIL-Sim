...
model Closet "Model of the closet connected to test cell X1A"
  ...
  parameter HeatTransfer.Data.OpaqueConstructions.Generic
    ...
    complete model of test cell X1A can be found in
    <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A\">
    Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A</a>.
    </p>
    <p>
