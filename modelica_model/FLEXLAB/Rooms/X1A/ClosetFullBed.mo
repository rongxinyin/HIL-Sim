...
model ClosetFullBed
  ...
  replaceable parameter
    Data.Constructions.OpaqueConstructions.DividingWalls.CellAndElectricalDividingWall
                                                                      higIns
    "High insulation wall. Between X1A closet and exterior, X1A closet and electrical room"
  ...
  replaceable parameter
    Data.Constructions.OpaqueConstructions.DividingWalls.TestCellDividngWall
                                                                         celDiv
    "Wall dividing the X1A closet and the X3B closet"
  ...
  replaceable parameter Data.Constructions.OpaqueConstructions.Roofs.ASHRAE_901_2010Roof
                                                                   roo
    "Construction of the roof of the closet in X1A"
  ...
  parameter HeatTransfer.Data.OpaqueConstructions.Generic
    ...
    <p>
    This is a duplicate model of <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A.Closet\">
    Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A.Closet</a> with the wall separating this model and
    ...
    Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A.Closet</a>. For information on the rest of the walls
    ...
    <p align=\"center\">
    <img src=\"modelica://Buildings/Resources/Images/ThermalZones/Detailed/FLEXLAB/Rooms/X1A/Closet.png\" border=\"1\" alt=\"Wall sections in Closet model\"/>
    </p>
    <p>
    ...
    X1A.ClosetNoCelDiv.surf_surBou[3] to this port models heat transfer from the wall in ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Closet to the air in this
    space.</td>
    </tr>
    </table>
    </html>",
