...
model Plenum "Model of LBNL User Test Facility Cell X1A Plenum"
  extends Buildings.ThermalZones.Detailed.MixedAir(AFlo=60.55,
      ...
      datConBou(
         ...
         stateAtSurface_a = {false, false, true, true, true, true}),
  ...
  replaceable parameter
    Data.Constructions.OpaqueConstructions.ExteriorConstructions.Construction9
                                                                     SouthExt
    annotation (Placement(transformation(extent={{384,-72},{404,-52}})));
  replaceable parameter
    Data.Constructions.OpaqueConstructions.ExteriorConstructions.Construction3
                                                                     NorthExt
    annotation (Placement(transformation(extent={{384,-98},{404,-78}})));
  replaceable parameter Data.Constructions.OpaqueConstructions.Roofs.CeilingTile ceiling
    annotation (Placement(transformation(extent={{384,-126},{404,-106}})));
  ...
  test cell X1A. Documentation describing how it is to be combined to other room models to create
  a model of the full test cell can be found in
  <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A\">Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X1A</a>.
  </p>
  <p>
  There are 7 different wall sections described in the model. They are shown in the figure below.
  </p>
  <p align=\"center\">
  <img src=\"modelica://Buildings/Resources/Images/ThermalZones/Detailed/FLEXLAB/Rooms/X1A/TestCell.png\" border=\"1\" alt=\"Wall sections in test cell model\"/>
  </p>
  <p>
  ...
  <tr>
  <td>1</td>
  <td>The west wall is modeled in two parts. One part represents the dividing wall between test cells X1A
  ...
  <tr>
  <td>2</td>
  <td>The west wall is modeled in two parts. One part represents the dividing wall between test cell X1A
  ...
  <tr>
  <td>3</td>
  <td>This is the north exterior wall of test cell X1A. There are actually two constructions
  ...
  X1A and the externally modeled electrical room. For an example see
  <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.Examples.X1AWithRadiantFloor\">
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.Examples.X1AWithRadiantFloor</a>.</td>
  <td>datConBou[5]</td>
  <td>R52Wal</td>
  </tr>
  <tr>
  ...
  <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.Examples.X1AWithRadiantFloor\">
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.Examples.X1AWithRadiantFloor</a>. Similar to wall section
  ...
  <tr>
  <td>7</td>
  <td>This is the south wall of test cell X1A. It includes both a wall construction and
  ...
  The following table describes the connections to models outside of the X1A package. The connections in datConExt
