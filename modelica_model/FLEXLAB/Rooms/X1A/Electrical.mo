...
model Electrical "Model of the electrical room attached to test cell X1A"
  ...
  <p align=\"center\">
  <img src=\"modelica://Buildings/Resources/Images/ThermalZones/Detailed/FLEXLAB/Rooms/X1A/Electrical.png\" border=\"1\" alt=\"Wall sections in TestCell model\"/>
  </p>
  <p>
  ...
  The following table describes the connections to rooms which are not in the X1A package. The constructions in
